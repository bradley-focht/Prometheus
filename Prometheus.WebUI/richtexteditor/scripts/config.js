...
window.RTE_Configuration =
{
	...
	skin: "office2007silver", //sets the skin for how the toolbar is draw
	...
	showtoolbar_code: false,//specifies whether to display the code mode toolbar
	showtoolbar_view: false,//specifies whether to display the preview toolbar 	
