    ...
    public class ServiceController : Controller
    {
        ...
        public ActionResult Index(string filterBy, string filterArg, int pageId = 0)
        {
            ...
            if (filterBy != "All")
            {
                ...
                else
                {
                    ...
                    try
                    {
                        arg = int.Parse(filterArg);
                    }
                    catch
                    {
                        model.Services = helper.GetServices();
                    } //no search string returns all services
        ...
        {         
            ...
            if (items.Any())
            {
                ...
                {
                    model.Options.Add((ICatalogable) item);
                }
            }
        ...
        public ActionResult AddOptionCategory(int id)
        {
            ...
            OptionCategoryModel model = new OptionCategoryModel {Action = "Add"};
            model.ServiceId = id;
