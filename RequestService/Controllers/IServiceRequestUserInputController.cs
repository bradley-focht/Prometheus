...
namespace RequestService.Controllers
{
	public interface IServiceRequestUserInputController
	{
		...
		/// <returns></returns>
		IServiceRequestUserInputDto GetServiceRequestUserInput(int userInputId);
		...
		IServiceRequestUserInputDto ModifyServiceRequestUserInput(IServiceRequestUserInputDto userInput, EntityModification modification);
	}
}
